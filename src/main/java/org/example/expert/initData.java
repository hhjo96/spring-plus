...
public class initData {
    ...
    public void init() {
        ...
        User alice = new User("user@example.com", passwordEncoder.encode("1234"), UserRole.USER, "alice");
        User bob = new User("user2@example.com", passwordEncoder.encode("1234"), UserRole.USER, "bob");
